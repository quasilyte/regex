...
func TestLexer(t *testing.T) {
	tests := []struct {
		...
		{`\(\)`, `EscapeChar Concat EscapeChar`},
		{`\\`, `EscapeChar`},
		{`\a`, `Escape`},
		{`\\d`, `EscapeChar Concat Char`},
		{`\d`, `Escape`},
		{`\d\a`, `Escape Concat Escape`},
		{`\dd\a`, `Escape Concat Char Concat Escape`},
		{`\D`, `Escape`},
		{`\s\S`, `Escape Concat Escape`},

		{`-`, `Char`},
		{`[\-]`, `[ EscapeChar ]`},
		{`a[]a`, `Char Concat [ ] Concat Char`},
		{`[\^a]a`, `[ Escape Char ] Concat Char`},
		{`[^a]a`, `[^ Char ] Concat Char`},
		{`a[^abc]a`, `Char Concat [^ Char Char Char ] Concat Char`},
		{`[[[]a`, `[ Char Char ] Concat Char`},
		{`[\[]a`, `[ EscapeChar ] Concat Char`},
		{`[\]]a`, `[ EscapeChar ] Concat Char`},
		{`aa[\]1\]]`, `Char Concat Char Concat [ EscapeChar Char EscapeChar ]`},
		{`aa[1\]\]2]`, `Char Concat Char Concat [ Char EscapeChar EscapeChar Char ]`},
